...
// //         accountHolderName: this.payments[index].accountHolderName,
// //         details: this.editingFullDetails
// //       });
// //     });
// //   }
...
// //     const updatedAccountHolderName = this.paymentForm.value.accountHolderName;
// //     const updatedDetails = this.paymentForm.value.details;

// //     this.payments[index].accountHolderName = updatedAccountHolderName;
// //     this.payments[index].details = updatedDetails;

// //     if (this.payments[index].id === 'credit' || this.payments[index].id === 'sepa') {
// //       this.payments[index].maskedDetails = `ending in ${updatedDetails.slice(-4)}`;
// //     } else {
// //       this.payments[index].maskedDetails = updatedDetails;
// //     }
...
// //   cancelAddOrEdit() {
// //     if (this.editingIndex !== null) {
// //       this.payments[this.editingIndex] = this.paymentBackup;
// //       this.editingIndex = null;
// //     }
// //     this.addingPayment = false;
// //     this.newPayment = { id: '', name: '', details: '', imageUrl: '', default: false, accountHolderName: '' };
...
//     this.paymentService.addPayment(this.newPayment);
//     this.selectPayment(this.newPayment); // Automatically select the newly added payment
//     this.resetNewPayment();
//     this.addingPayment = false;
//     this.payments = this.paymentService.getPayments();
//     this.paymentSelectionChange.emit(true);
...
export class DeliveryPaymentComponent {
  ...
  onPaymentTypeChange(): void {
    if (this.selectedPaymentType) {
      this.currentDetailsPlaceholder = this.selectedPaymentType?.inputPlaceholder || '';
      this.currentInputType = this.selectedPaymentType.id === 'paypal' ? 'email' : 'text';
  ...
  selectPaymentTypeByType(paymentType: PaymentType): void {
    this.selectedPaymentType = paymentType;
    this.currentDetailsPlaceholder = paymentType.inputPlaceholder;
    this.currentInputType = paymentType.id === 'paypal' ? 'email' : 'text';
