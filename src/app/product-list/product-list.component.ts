...
//   onSearchClick(): void {
//     const isSmallScreen = window.innerWidth <= 432; // Adjust screen width as needed
//     if (this.onSearchResultsPage || isSmallScreen) {
//       this.filterService.toggleFilters(); // Use the service to toggle the filters
//     } else {
//       this.router.navigate(['/search-results']);
//     }
...
//         setTimeout(() => {
//           this.filterService.toggleFilters(); // Ensure filters are toggled after navigation
//         }, 100); // Small delay to ensure the navigation is complete
//       });
//     }
//   }
