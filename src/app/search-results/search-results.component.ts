...
// import { Product } from '../services/product';
// import { Observable } from 'rxjs';
// import { debounceTime, switchMap } from 'rxjs/operators';  // <-- Import debounceTime and switchMap
...
//     // Listen to the filter visibility changes
//     this.filterService.filterVisibility$.subscribe(visible => {
